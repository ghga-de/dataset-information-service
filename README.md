...
```bash
docker pull ghga/dataset-information-service:4.2.1
```

Or you can build the container yourself from the [`./Dockerfile`](./Dockerfile):
```bash
# Execute in the repo's root dir:
docker build -t ghga/dataset-information-service:4.2.1 .
```
...
docker run -p 8080:8080 ghga/dataset-information-service:4.2.1 --help
```
